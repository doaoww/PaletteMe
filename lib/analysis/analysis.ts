...
в”Ѓв”Ѓ STEP 1: OBSERVE RAW FEATURES в”Ѓв”Ѓ
Examine carefully:
вЂў SKIN вЂ” base undertone: warm (golden/peachy/yellow/olive) OR cool (pink/rosy/ashy/bluish)? How light or deep overall?
вЂў HAIR вЂ” natural depth: light / medium / dark. Warmth: warm (golden/red/auburn/chocolate) OR cool (ash/silver/blue-black)?
вЂў EYES вЂ” color and clarity: do they spark brightly or appear muted/soft?
вЂў OVERALL CONTRAST вЂ” are features blended (hair/skin similar = low contrast) or strikingly different (dark hair + light skin = high contrast)?

в”Ѓв”Ѓ STEP 2: MATCH TO ONE OF THESE 12 SUB-SEASONS в”Ѓв”Ѓ

рџЊё SPRING вЂ” warm undertone, clear coloring (never muted):
вЂў "True Spring"   в†’ warm medium skin, golden/chestnut hair, clear hazel/green/golden-brown eyes, medium contrast
вЂў "Light Spring"  в†’ fair warm skin, light golden/strawberry-blonde hair, light blue/green eyes, very low contrast
вЂў "Bright Spring" в†’ warm skin, dark warm hair, bright vivid eyes (blue/teal/green), high contrast + very clear

вЂпёЏ SUMMER вЂ” cool undertone, soft/muted coloring:
вЂў "True Summer"   в†’ cool rosy skin, ash-blonde/light ash-brown hair, blue/grey-blue/grey eyes, low-medium contrast
вЂў "Light Summer"  в†’ very fair cool skin, pale ash-blonde hair, pale blue/grey eyes, extremely low contrast
вЂў "Soft Summer"   в†’ cool-neutral, medium ash-brown hair, muted blue-grey/soft hazel eyes, low contrast, most muted of all

рџЌ‚ AUTUMN вЂ” warm undertone, muted/rich coloring:
вЂў "True Autumn"   в†’ warm golden/olive skin, rich auburn/copper/chestnut hair, amber/hazel/golden-green eyes, medium contrast
вЂў "Soft Autumn"   в†’ warm-neutral, mousy/warm medium-brown hair, muted hazel/green/warm brown eyes, very low contrast
вЂў "Dark Autumn"   в†’ deep warm skin, dark chocolate/warm-black hair, dark brown/olive eyes, medium-high contrast

вќ„пёЏ WINTER вЂ” cool undertone, clear OR deep coloring:
вЂў "True Winter"   в†’ cool skin (rosy or cool-olive), dark ash-brown/black hair, dark cool-brown eyes, high contrast
вЂў "Bright Winter" в†’ cool skin, very dark hair, strikingly bright eyes (icy blue/vivid green/clear hazel), extremely high contrast
вЂў "Dark Winter"   в†’ cool-neutral, very dark hair, very dark eyes, deep/dramatic overall

в”Ѓв”Ѓ STEP 3: SCORE CONFIDENCE в”Ѓв”Ѓ
90-100 в†’ clear photo, natural light, features obvious
70-89  в†’ most features readable, minor ambiguity
50-69  в†’ heavy filter, poor lighting, or genuinely borderline
< 50   в†’ cannot determine reliably вЂ” say so in summary

в”Ѓв”Ѓ OUTPUT в”Ѓв”Ѓ
Return ONLY this JSON вЂ” no markdown, no extra text:
{
...
Also note the face shape (oval, round, square, heart, oblong, or diamond) from visible bone structure вЂ” jawline width, forehead width, face length. Set to null if the angle or hair makes it impossible to determine.
  ...
  for (const modelName of models) {
    try {
      ...
      if (isRetryableError(error)) {
        console.warn(`[analyze] ${modelName} unavailable, trying nextвЂ¦`);
        continue;
      }
      throw error;
    }
...
в”Ѓв”Ѓ ONBOARDING QUIZ (soft prior вЂ” photo evidence wins) в”Ѓв”Ѓ
${profileBlock}
