...
export const SEASONS: Season[] = [
  {
    ...
    cbg: "#FDF4E8",
    cac: "#E8A87C",
    palette: ["#FFDAB9", "#F4936A", "#7DDDE2", "#F7DC6F", "#FD9FAF", "#C09B30", "#FFE4B5", "#F4784A"],
    paletteNames: ["Peach Blossom", "Warm Coral", "Clear Turquoise", "Buttercup", "Warm Pink", "Marigold", "Honey Cream", "Mandarin"],
  ...
  },
  {
    ...
    cbg: "#E8E4ED",
    cac: "#6B5B95",
    palette: ["#1B2A4A", "#5F2566", "#C20018", "#F0F4F8", "#D8C8E8", "#0A0A0A", "#0047AB", "#C7338A"],
    paletteNames: ["Deep Navy", "Dark Plum", "True Red", "Icy White", "Icy Lavender", "True Black", "Cobalt Blue", "Fuchsia"],
...
export const PRODUCTS = [
  { name: "V-Neck Maxi Slip Dress", brand: "ASOS DESIGN", price: "€33", match: 96, image: "/images/demo/product-1.jpg", url: "https://www.asos.com/asos-design/asos-design-v-neck-maxi-slip-dress-in-green-laundered-stripe/prd/211084660", swatches: ["#4A7C59", "#6B9E7A", "#2D5A3D"] },
  { name: "Knitted One Shoulder Top", brand: "Topshop", price: "€32", match: 91, image: "/images/demo/product-2.jpg", url: "https://www.asos.com/topshop/topshop-knitted-asymmetric-one-shoulder-colour-pop-top-in-multi/prd/210944116", swatches: ["#E85D04", "#9B2335", "#2D6A8F"] },
  { name: "Cami Top with Lace Hem", brand: "ASOS DESIGN", price: "€30", match: 93, image: "/images/demo/product-3.jpg", url: "https://www.asos.com/asos-design/asos-design-cami-top-with-lace-hem-in-chocolate-polka-dot/prd/211167554", swatches: ["#5C3A1E", "#8B5E3C", "#3B2110"] },
];
...
export const FAQS = [
  {
    ...
    a: "No. PaletteMe is designed for both women and men. Some sections, like makeup or nails, may be shown only when relevant.",
  },
  {
    q: "Do I need makeup in my photo?",
    a: "No. A clear natural photo works best.",
  },
  {
    q: "Can I upload any photo?",
    a: "For best results, use a clear front-facing photo in natural light.",
  },
  {
    q: "How is this different from a color season quiz?",
    a: "PaletteMe analyzes your actual photo and gives a full appearance report, not just a quiz result.",
  },
  {
    q: "What do I get for free?",
    a: "You get a mini result with your color season and a preview of your best colors.",
  },
  {
    q: "What is included in the paid report?",
    a: "The paid report includes color season, best colors, contrast, hair colors, haircuts, glasses, jewelry metals, makeup shades where applicable, nails and explanations.",
  },
  {
    q: "Is my photo private?",
    a: "Photos are processed securely for analysis. PaletteMe does not sell or share your images.",
  },
];
