...
export const STYLE_PAIRS: StylePair[] = [
  ...
  },
  {
    ...
    a: {
      ...
      image: "/images/quiz/style-5a.jpg",
      tags: {
        aesthetics: ["classic"],
        fit: ["tailored"],
    ...
    b: {
      ...
      image: "/images/quiz/style-5b.jpg",
      tags: {
        aesthetics: ["sporty"],
        fit: ["relaxed"],
  ...
  },
  {
    ...
    a: {
      ...
      image: "/images/quiz/style-6a.jpg",
      tags: {
    ...
    b: {
      ...
      image: "/images/quiz/style-6b.jpg",
